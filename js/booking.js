...
{
var xmlhttp = new XMLHttpRequest();
var url= "util/timer.php?rank="+rank;
var info='';
xmlhttp.onreadystatechange = function()
{
if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
...
var x=0;
var max_pref = rank%7;
max_pref = (max_pref==0?7:max_pref);
...
function toggleclass(el,id)
{
	...
	if (el.className == "available")
	{
		...
		if(room.length>=max_pref)
		{
			window.alert("You Have Reached Maximum Number Of Prefrences!");
		}
		else
		{
...
var url= "util/fillpref.php?rank="+rank+"&Adm_no="+adm+"&p1="+code[0]+"&p2="+code[1]+"&p3="+code[2]+"&p4="+code[3]+"&p5="+code[4]+"&p6="+code[5]+"&p7="+code[6];
var info='';
