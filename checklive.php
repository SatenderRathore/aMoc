...
?>
  <head>
    ...
    <title>CheckLive</title>
    <link rel="stylesheet" type="text/css" href="css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="css/checklive.css">
  ...
  <body ng-app="func" ng-controller="show">
    ...
    <div class="nehru" id="nehru_second">
        ...
        <footer>
            <center><a href="#tagore_a"><img src="img/arrow.png"></a></center>
        </footer>
    </div>
    ...
    <div class="tagore" id="tagore_b">
        ...
        <footer>
            <center><a href="#bhabha_first"><img src="img/arrow.png"></a></center>
        </footer>
    </div>
...
<script src="js/checklive.js"></script>
  </body>
  </html>